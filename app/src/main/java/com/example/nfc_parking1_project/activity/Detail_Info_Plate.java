...
//                startActivity(intent);
    ...
    private void getHistory(String cardId) {
        HistoryAPI.historyApi.getHistory(Constant.TOKEN, cardId).enqueue(new Callback<History>() {
            @Override
    ...
    private void confirmVehicleOut() {
        HistoryAPI.historyApi.vehicleOut(Constant.TOKEN, historyId).enqueue(new Callback<MessageResponse>() {
            @Override
